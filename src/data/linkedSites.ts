...
export const linkedSites: LinkedSite[] = [
  ...
  {name: "Official X", url: "https://x.com/cfm_miku_en", showInFooter: true},
  {
    ...
    url: "https://www.facebook.com/HatsuneMikuOfficialPage",
    showInFooter: true
  },
  {
    name: "Official Instagram",
    url: "https://www.instagram.com/cfm_mikustagram/",
    showInFooter: true
  },
  {name: "KARENT Music", url: "https://karent.jp/", showInFooter: true},
  {name: "K!!te", url: "https://kiite.jp/", showInFooter: true},
  {name: "마지미라 정보", url: "https://mm-info.miku.kr/", showInFooter: false},
  {
    name: "보카로 가사 위키",
    url: "https://vocaloidlyrics.fandom.com/wiki/VOCALOID_Lyrics_Wiki",
    showInFooter: false
  },
  {name: "Vocaloid collection", url: "https://vocaloid-collection.jp/", showInFooter: false},
  ...
  {name: "Vocabirth", url: "https://vocabirth.netlify.app/", showInFooter: false},
];

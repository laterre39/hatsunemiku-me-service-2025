...
import { VocaCommunity } from "@/services/communityService";

const INITIAL_VISIBLE_COUNT = 6;

interface VocaloidCommunityProps {
  communities: VocaCommunity[];
}

export function VocaloidCommunity({ communities }: VocaloidCommunityProps) {

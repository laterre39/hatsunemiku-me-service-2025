...
export function EventSchedule({ events: initialEvents }: EventScheduleProps) {
          ...
          {displayedEvents.map((event, index) => {
            ...
            return (
              <li key={event.id} className="relative">
                ...
                {/* Card */}
                <div
                  className={`w-full rounded-lg bg-white/5 p-4 shadow-lg ring-1 ring-white/10 transition-transform duration-300 hover:scale-105 hover:ring-white/20 md:w-[calc(50%-2rem)] ${
                    index % 2 === 0
                      ? "md:ml-auto md:pl-8"
